...
class Configuration:
    ...
    seed = 1
    epochs: int = 10
    batch_size: int = 20                # keep in mind real_batch_size = 2 * batch_size
    verbose: bool = False
    ...
    train_pairs_meta_file = '/data3/czh_code/gta/GTA-UAV-LR/cross-area-drone2sate-train.json'
    test_pairs_meta_file = '/data3/czh_code/gta/GTA-UAV-LR/cross-area-drone2sate-test.json'
