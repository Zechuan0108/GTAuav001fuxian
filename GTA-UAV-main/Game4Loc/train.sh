...
nohup python train_gta.py --data_root '/data3/czh_code/gta/GTA-UAV-LR' --train_pairs_meta_file "cross-area-drone2sate-train.json" --test_pairs_meta_file "cross-area-drone2sate-test.json" --gpu_ids 0,1 --with_weight --k 5 --epoch 5 --model 'vit_base_patch16_rope_reg1_gap_256.sbb_in1k' --lr 0.0001 --batch_size 20 > train.log 2>&1 &
nohup python train_gta.py --data_root '/data3/czh_code/gta/GTA-UAV-LR' --train_pairs_meta_file "same-area-drone2sate-train.json" --test_pairs_meta_file "same-area-drone2sate-test.json" --gpu_ids 6,7 --with_weight --k 5 --epoch 5 --model 'vit_base_patch16_rope_reg1_gap_256.sbb_in1k' --lr 0.0001 --batch_size 40 > train.log 2>&1 &
